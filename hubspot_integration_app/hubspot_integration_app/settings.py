"""
Django settings for hubspot_integration_app project.
...
SECRET_KEY = 'vtc8p2!hld^+pmjge5nf%z=+pa!rd9+rtv4elu*mik58*aizzt'
...
ROOT_URLCONF = 'hubspot_integration_app.urls'
...
WSGI_APPLICATION = 'hubspot_integration_app.wsgi.application'
